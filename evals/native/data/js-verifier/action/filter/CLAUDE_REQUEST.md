...
## Objective
Type "Bill" in the search filter to filter the list

## Task
Analyze the BEFORE and AFTER snapshots and generate JavaScript validation code.

## Files to Analyze
- BEFORE: native/data/js-verifier/action/filter/before.html
- AFTER: native/data/js-verifier/action/filter/after.html
- DIFF: native/data/js-verifier/action/filter/diff.txt
...
- **Tab ID (AFTER - task completed):** 4B6B356F0F193E3DFBE31F7B65270750
- **Tab ID (BEFORE - initial state):** 7D3D576036CECAFEC0A5913923BA5118
...
curl -X POST http://localhost:8080/page/execute \
  ...
  -d '{
    ...
    "tabId": "4B6B356F0F193E3DFBE31F7B65270750",
...
curl -X POST http://localhost:8080/page/execute \
  ...
  -d '{
    "clientId": "4af9762d-c210-4c82-b5ff-a261c1167c04",
    "tabId": "7D3D576036CECAFEC0A5913923BA5118",
    "expression": "YOUR_JAVASCRIPT_CODE_HERE",
    "returnByValue": true,
    "awaitPromise": false
  }'
...
1. Write validation code to: native/data/js-verifier/action/filter/verify.js
...
4. If you get errors or wrong results:
   - Read the existing native/data/js-verifier/action/filter/verify.js
...
native/data/js-verifier/action/filter/verify.js
